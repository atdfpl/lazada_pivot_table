(function() {
    ...
    (t = function(t) {
        ...
        return i = function(t, e, n) {
        ...
        }, t.fn.pivotUI2 = function(n, r, i, s) {
            ...
            null == i && (i = !1), null == s && (s = "en"), null == d[s] && (s = "en"), v = {
                ...
                localeStrings: _
            }, C = this.data("pivotUI2Options"), D = null == C || i ? t.extend(!0, {}, k, t.extend({}, v, r)) : C;
            try {
                ...
                null != D.aggregatorName && this.find(".pvtAggregator").val(D.aggregatorName), null != D.rendererName && this.find(".pvtRenderer").val(D.rendererName), A = !0, V = function(n) {
                    return function() {
                        ...
                        return A && (y = D.vals, w = 0, n.find(".pvtVals select.pvtAttrDropdown").each(function() {
                            ...
                            rendererName: j.val()
                        }), n.data("pivotUI2Options", l), D.autoSortUnusedAttrs && (C = n.find("td.pvtUnused.pvtAxisContainer"), t(C).children("li").sort(function(e, n) {
